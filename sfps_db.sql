...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2024 at 08:21 AM
...
CREATE TABLE `discount` (
  `discount` decimal(5,4) NOT NULL DEFAULT 0.1000
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `student_ef_list` (`id`, `student_id`, `ef_no`, `course_id`, `total_fee`, `date_created`, `voucher`, `discount`) VALUES
(1, 2, '2020-654278', 1, 4500, '2020-10-31 12:04:18', '450.00', '900.00'),
(2, 1, '2020-65427823', 1, 4500, '2020-10-31 13:12:13', '450.00', '900.00');
...
CREATE TABLE `voucher` (
  `voucher` decimal(5,4) NOT NULL DEFAULT 0.1000
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

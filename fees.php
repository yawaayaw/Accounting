                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span class="float:right">
                            <a class="btn btn-primary btn-block btn-sm col-sm-2 float-right" href="javascript:void(0)" id="new_fees">
                        ...
                        <table class="table table-condensed table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                while($row = $fees->fetch_assoc()):
                                    ...
                                    $balance = $row['total_fee'] - $voucher - $discount - $paid;
                                ?>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <p><b><?php echo number_format($voucher, 2) ?></b></p>
                                    </td>
                                    <td class="text-right">
